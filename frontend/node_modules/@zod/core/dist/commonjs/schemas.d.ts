...
type $InferZodRecordOutput<Key extends $ZodRecordKey = $ZodRecordKey, Value extends $ZodType = $ZodType> = undefined extends Key["_zod"]["values"] ? string extends Key["_zod"]["output"] ? Record<Key["_zod"]["output"], Value["_zod"]["output"]> : number extends Key["_zod"]["output"] ? Record<Key["_zod"]["output"], Value["_zod"]["output"]> : symbol extends Key["_zod"]["output"] ? Record<Key["_zod"]["output"], Value["_zod"]["output"]> : Partial<Record<Key["_zod"]["output"], Value["_zod"]["output"]>> : Record<Key["_zod"]["output"], Value["_zod"]["output"]>;
