...
export declare class $ZodJSONSchemaRegistry<Meta extends JSONSchemaMeta = JSONSchemaMeta, Schema extends $ZodType = $ZodType> extends $ZodRegistry<Meta, Schema> {
    toJSONSchema(_schema: Schema): object;
}
export interface GlobalMeta extends JSONSchemaMeta {
}
export declare const globalRegistry: $ZodJSONSchemaRegistry<GlobalMeta>;
export declare function registry<T extends MetadataType = MetadataType, S extends $ZodType = $ZodType>(): $ZodRegistry<T, S>;
export declare function jsonSchemaRegistry<T extends JSONSchemaMeta = JSONSchemaMeta, S extends $ZodType = $ZodType>(): $ZodJSONSchemaRegistry<T, S>;
export {};
