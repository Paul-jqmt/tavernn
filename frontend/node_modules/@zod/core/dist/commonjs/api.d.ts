...
export declare function _any<T extends schemas.$ZodAny>(Class: util.SchemaClass<T>, params?: string | $ZodAnyParams): T;
export type $ZodUnknownParams = util.TypeParams<schemas.$ZodUnknown>;
export declare function _unknown<T extends schemas.$ZodUnknown>(Class: util.SchemaClass<T>, params?: string | $ZodUnknownParams): T;
...
export declare function _array<T extends schemas.$ZodType>(Class: util.SchemaClass<schemas.$ZodArray>, element: T, params?: $ZodArrayParams): schemas.$ZodArray<T>;
...
export declare function _interface<T extends schemas.$ZodLooseShape>(Class: util.SchemaClass<schemas.$ZodInterface>, shape: T, params?: $ZodInterfaceParams): schemas.$ZodInterface<util.CleanInterfaceShape<T>, util.InitInterfaceParams<T, {}>>;
export declare function _strictInterface<T extends schemas.$ZodLooseShape>(Class: util.SchemaClass<schemas.$ZodInterface>, shape: T, params?: $ZodInterfaceParams): schemas.$ZodInterface<util.CleanInterfaceShape<T>, util.InitInterfaceParams<T, {}>>;
export declare function _looseInterface<T extends schemas.$ZodLooseShape>(Class: util.SchemaClass<schemas.$ZodInterface>, shape: T, params?: $ZodInterfaceParams): schemas.$ZodInterface<util.CleanInterfaceShape<T>, util.InitInterfaceParams<T, Record<string, unknown>>>;
export type $ZodObjectParams = util.TypeParams<schemas.$ZodObject, "shape" | "catchall">;
export declare function _object<T extends schemas.$ZodShape = Record<never, schemas.$ZodObject>>(Class: util.SchemaClass<schemas.$ZodObject>, shape?: T, params?: $ZodObjectLikeParams): schemas.$ZodObject<T, {}>;
export declare function _strictObject<T extends schemas.$ZodShape>(Class: util.SchemaClass<schemas.$ZodObject>, shape: T, params?: $ZodObjectParams): schemas.$ZodObject<T, {}>;
export declare function _looseObject<T extends schemas.$ZodShape>(Class: util.SchemaClass<schemas.$ZodObject>, shape: T, params?: $ZodObjectParams): schemas.$ZodObject<T, {
    [k: string]: unknown;
}>;
export type $ZodUnionParams = util.TypeParams<schemas.$ZodUnion, "options">;
export declare function _union<const T extends readonly schemas.$ZodObject[]>(Class: util.SchemaClass<schemas.$ZodUnion>, options: T, params?: $ZodUnionParams): schemas.$ZodUnion<T>;
...
export declare function _discriminatedUnion<Types extends [$ZodTypeDiscriminable, ...$ZodTypeDiscriminable[]]>(Class: util.SchemaClass<schemas.$ZodDiscriminatedUnion>, options: Types, params?: $ZodDiscriminatedUnionParams): schemas.$ZodDiscriminatedUnion<Types>;
export type $ZodIntersectionParams = util.TypeParams<schemas.$ZodIntersection, "left" | "right">;
export declare function _intersection<T extends schemas.$ZodObject, U extends schemas.$ZodObject>(Class: util.SchemaClass<schemas.$ZodIntersection>, left: T, right: U, params?: $ZodIntersectionParams): schemas.$ZodIntersection<T, U>;
export type $ZodTupleParams = util.TypeParams<schemas.$ZodTuple, "items" | "rest">;
export declare function _tuple<T extends readonly [schemas.$ZodType, ...schemas.$ZodType[]]>(Class: util.SchemaClass<schemas.$ZodTuple>, items: T, params?: $ZodTupleParams): schemas.$ZodTuple<T, null>;
export declare function _tuple<T extends readonly [schemas.$ZodType, ...schemas.$ZodType[]], Rest extends schemas.$ZodType>(Class: util.SchemaClass<schemas.$ZodTuple>, items: T, rest: Rest, params?: $ZodTupleParams): schemas.$ZodTuple<T, Rest>;
export type $ZodRecordParams = util.TypeParams<schemas.$ZodRecord, "keyType" | "valueType">;
export declare function _record<Key extends schemas.$ZodRecordKey, Value extends schemas.$ZodObject>(Class: util.SchemaClass<schemas.$ZodRecord>, keyType: Key, valueType: Value, params?: $ZodRecordParams): schemas.$ZodRecord<Key, Value>;
export type $ZodMapParams = util.TypeParams<schemas.$ZodMap, "keyType" | "valueType">;
export declare function _map<Key extends schemas.$ZodObject, Value extends schemas.$ZodObject>(Class: util.SchemaClass<schemas.$ZodMap>, keyType: Key, valueType: Value, params?: $ZodMapParams): schemas.$ZodMap<Key, Value>;
export type $ZodSetParams = util.TypeParams<schemas.$ZodSet, "valueType">;
export declare function _set<Value extends schemas.$ZodObject>(Class: util.SchemaClass<schemas.$ZodSet>, valueType: Value, params?: $ZodSetParams): schemas.$ZodSet<Value>;
export type $ZodEnumParams = util.TypeParams<schemas.$ZodEnum, "entries">;
export declare function _enum<const T extends string[]>(Class: util.SchemaClass<schemas.$ZodEnum>, values: T, params?: $ZodEnumParams): schemas.$ZodEnum<util.ToEnum<T[number]>>;
export declare function _enum<T extends util.EnumLike>(Class: util.SchemaClass<schemas.$ZodEnum>, entries: T, params?: $ZodEnumParams): schemas.$ZodEnum<T>;
 ...
 * ```
 */
export declare function _nativeEnum<T extends util.EnumLike>(Class: util.SchemaClass<schemas.$ZodEnum>, entries: T, params?: $ZodEnumParams): schemas.$ZodEnum<T>;
export type $ZodLiteralParams = util.TypeParams<schemas.$ZodLiteral, "values">;
export declare function _literal<const T extends Array<util.Literal>>(Class: util.SchemaClass<schemas.$ZodLiteral>, value: T, params?: $ZodLiteralParams): schemas.$ZodLiteral<T[number]>;
export declare function _literal<const T extends util.Literal>(Class: util.SchemaClass<schemas.$ZodLiteral>, value: T, params?: $ZodLiteralParams): schemas.$ZodLiteral<T>;
...
export declare function _transform<I = unknown, O = I>(Class: util.SchemaClass<schemas.$ZodTransform>, fn: (input: I, ctx?: schemas.ParsePayload) => O, params?: $ZodTransformParams): schemas.$ZodTransform<Awaited<O>, I>;
export type $ZodOptionalParams = util.TypeParams<schemas.$ZodOptional, "innerType">;
export declare function _optional<T extends schemas.$ZodObject>(Class: util.SchemaClass<schemas.$ZodOptional>, innerType: T, params?: $ZodOptionalParams): schemas.$ZodOptional<T>;
export type $ZodNullableParams = util.TypeParams<schemas.$ZodNullable, "innerType">;
export declare function _nullable<T extends schemas.$ZodObject>(Class: util.SchemaClass<schemas.$ZodNullable>, innerType: T, params?: $ZodNullableParams): schemas.$ZodNullable<T>;
export type $ZodDefaultParams = util.TypeParams<schemas.$ZodDefault, "innerType" | "defaultValue">;
export declare function _default<T extends schemas.$ZodObject>(Class: util.SchemaClass<schemas.$ZodDefault>, innerType: T, defaultValue: util.NoUndefined<core.output<T>> | (() => util.NoUndefined<core.output<T>>), params?: $ZodDefaultParams): schemas.$ZodDefault<T>;
export type $ZodNonOptionalParams = util.TypeParams<schemas.$ZodNonOptional, "innerType">;
export declare function _nonoptional<T extends schemas.$ZodObject>(Class: util.SchemaClass<schemas.$ZodNonOptional>, innerType: T, params?: $ZodNonOptionalParams): schemas.$ZodNonOptional<T>;
export type $ZodSuccessParams = util.TypeParams<schemas.$ZodSuccess, "innerType">;
export declare function _success<T extends schemas.$ZodObject>(Class: util.SchemaClass<schemas.$ZodSuccess>, innerType: T, params?: $ZodSuccessParams): schemas.$ZodSuccess<T>;
export type $ZodCatchParams = util.TypeParams<schemas.$ZodCatch, "innerType" | "catchValue">;
export declare function _catch<T extends schemas.$ZodObject>(Class: util.SchemaClass<schemas.$ZodCatch>, innerType: T, catchValue: core.output<T> | ((ctx: schemas.$ZodCatchCtx) => core.output<T>), params?: $ZodCatchParams): schemas.$ZodCatch<T>;
export type $ZodPipeParams = util.TypeParams<schemas.$ZodPipe, "in" | "out">;
export declare function _pipe<const A extends schemas.$ZodType, B extends schemas.$ZodType<unknown, core.output<A>> = schemas.$ZodType<unknown, core.output<A>>>(Class: util.SchemaClass<schemas.$ZodPipe>, in_: A, out: B | schemas.$ZodType<unknown, core.output<A>>, params?: $ZodPipeParams): schemas.$ZodPipe<A, B>;
export type $ZodReadonlyParams = util.TypeParams<schemas.$ZodReadonly, "innerType">;
export declare function _readonly<T extends schemas.$ZodObject>(Class: util.SchemaClass<schemas.$ZodReadonly>, innerType: T, params?: $ZodReadonlyParams): schemas.$ZodReadonly<T>;
export type $ZodTemplateLiteralParams = util.TypeParams<schemas.$ZodTemplateLiteral, "parts">;
export declare function _templateLiteral<const Parts extends schemas.$TemplateLiteralPart[]>(Class: util.SchemaClass<schemas.$ZodTemplateLiteral>, parts: Parts, params?: $ZodTemplateLiteralParams): schemas.$ZodTemplateLiteral<schemas.$PartsToTemplateLiteral<Parts>>;
export type $ZodLazyParams = util.TypeParams<schemas.$ZodLazy, "getter">;
export declare function _lazy<T extends schemas.$ZodType>(Class: util.SchemaClass<schemas.$ZodLazy>, getter: () => T, params?: $ZodLazyParams): schemas.$ZodLazy<T>;
export type $ZodPromiseParams = util.TypeParams<schemas.$ZodPromise, "innerType">;
export declare function _promise<T extends schemas.$ZodObject>(Class: util.SchemaClass<schemas.$ZodPromise>, innerType: T, params?: $ZodPromiseParams): schemas.$ZodPromise<T>;
...
}, _params?: $ZodStringBoolParams): schemas.$ZodPipe<schemas.$ZodUnknown, schemas.$ZodBoolean<boolean>>;
