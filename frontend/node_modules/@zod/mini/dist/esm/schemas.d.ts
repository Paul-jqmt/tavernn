...
declare function _interface<T extends core.$ZodLooseShape>(shape: T, params?: string | core.$ZodInterfaceParams, Class?: util.Constructor<ZodMiniInterface>): ZodMiniInterface<util.CleanInterfaceShape<T>, util.InitInterfaceParams<T, {}>>;
export { _interface as interface };
export declare function strictInterface<T extends core.$ZodLooseShape>(shape: T, params?: string | core.$ZodInterfaceParams): ZodMiniInterface<util.CleanInterfaceShape<T>, util.InitInterfaceParams<T, {}>>;
export declare function looseInterface<T extends core.$ZodLooseShape>(shape: T, params?: string | core.$ZodInterfaceParams): ZodMiniInterface<util.CleanInterfaceShape<T>, util.InitInterfaceParams<T, Record<string, unknown>>>;
...
export declare function object<T extends core.$ZodShape = Record<never, SomeType>>(shape?: T, params?: string | core.$ZodObjectLikeParams): ZodMiniObject<T, {}>;
export declare function strictObject<T extends core.$ZodShape>(shape: T, params?: string | core.$ZodObjectParams): ZodMiniObject<T, {}>;
export declare function looseObject<T extends core.$ZodShape>(shape: T, params?: string | core.$ZodObjectParams): ZodMiniObject<T, {
    [k: string]: unknown;
}>;
